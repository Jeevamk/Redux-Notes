...
- The patterns and tools provided by redux make it easier to understand when, where,why and how the state in your application is 
  updated and how the logic will behave when those change occur. <hr>
...
- The app has medium or large-sized codebase,and many people worked on that app.<hr>
